...
public class ChannelManage {
    ...
    static {
        ...
        defaultUserChannels.add(new ChannelItem(7, "GameMei", 7, 1));
        //其他关注
        defaultOtherChannels = new ArrayList<ChannelItem>();
        defaultOtherChannels.add(new ChannelItem(8, "魔兽世界", 1, 0));
        defaultOtherChannels.add(new ChannelItem(9, "炉石传说", 2, 0));
        ...
        defaultOtherChannels.add(new ChannelItem(19, "社会", 12, 0));
        defaultOtherChannels.add(new ChannelItem(20, "情感", 13, 0));
        defaultOtherChannels.add(new ChannelItem(21, "刀塔传奇", 14, 0));
        defaultOtherChannels.add(new ChannelItem(22, "旅游", 15, 0));
        defaultOtherChannels.add(new ChannelItem(23, "健康", 16, 0));
        defaultOtherChannels.add(new ChannelItem(24, "美女", 17, 0));
        defaultOtherChannels.add(new ChannelItem(25, "游戏", 18, 0));
        defaultOtherChannels.add(new ChannelItem(26, "数码", 19, 0));
